/****************************************************************************
** Meta object code from reading C++ file 'search_home.h'
**
...
#include <memory>
#include "../../../../src/frontend/window/search_screen/search_home.h"
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'search_home.h' doesn't include <QObject>."
...
void SearchWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SearchWindow::timer_signal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchWindow::timer_signal()
{
